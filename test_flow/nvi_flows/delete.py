...
def delete(oauth_service: OAuth, prs_service: PRS, nvi_service: NVI, bsn: str|None=None, care_context: str|None=None) -> None:
    print("Deleting referrals for BSN:", bsn, "and care context:", care_context)
    if bsn is not None:
        personal_identifier = {
            "landCode": "NL",
            "type": "BSN",
